...
aug_ohl_list_name.append("identity.")
...
aug_ohl_list_name.append('FlipLR.')
flip_ud = TransformT(
    'FlipUD',
...
aug_ohl_list_name.append('FlipUD.')
...
aug_ohl_list_name.append( 'AutoContrast.')
equalize = TransformT(
    'Equalize',
...
aug_ohl_list_name.append('Equalize.')
invert = TransformT(
    'Invert',
...
aug_ohl_list_name.append('Invert.')
...
aug_ohl_list_name.append("Smooth.")
...
for m in M_list:
  ...
  aug_ohl_list_name.append("Rotate."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Posterize."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("ShearX."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("ShearY."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("TranslateX."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("TranslateY."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Solarize."+str(m))
...
for m in M_list:
  mop = lambda pil_img:cutout.do_transform(pil_img, m)
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Cutout."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Color."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Contrast."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Brightness."+str(m))
...
for m in M_list:
  ...
  aug_ohl_list.append(mop)
  aug_ohl_list_name.append("Sharpness."+str(m))
...
class RandAugment_ohl:
    def __init__(self, n):
        self.n = n
        self.augment_list = aug_all_cifar
        self.th=1
