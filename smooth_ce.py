...
class SmoothCrossEntropyLoss(Module):
    def __init__(self, label_smoothing=0.0, size_average=True, reduction='mean'):
        super().__init__()
    ...
    def forward(self, input, target):
        ...
        return cross_entropy(input, target, self.size_average, self.reduction)


def cross_entropy(input, target, size_average=True, reduction='mean'):
