    ...
    for epoch in range(epoch_start, max_epoch + 1):
        if args.load_tp == 'none':
            ...
            if flag_load == 1:
                ...
                th_ls = 1-np.power(max_probs,1/args.sqrt)
                flag_load = 0
            th_epoch = th_ls[int(epoch/(max_epoch/len(th_ls)))]
            trainloader.dataset.transform.transforms[0].p = dis_ps[int(epoch/(max_epoch/len(th_ls)))]
